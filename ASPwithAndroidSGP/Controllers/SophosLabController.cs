...
{
    public class SophosLabController : Controller
    {
        string MainPath = "Labs/Sophos Lab";
        // GET: SophosLabController
        ...
        // GET: SophosLabController/Details/5
        ...
        // GET: SophosLabController/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: SophosLabController/Create
        [HttpPost]
        ...
        // GET: SophosLabController/Edit/5
        ...
        // POST: SophosLabController/Edit/5
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: SophosLabController/Delete/5
        [HttpGet]
